                        ...
                        $number = 1;
                          ...
                          while($row = mysqli_fetch_assoc($result)){
                            $data .= '<tr>
                                        ...
                                        <td>
                                            <div class="media-body">
                                                <h6 class="text-primary">'.$row['contact'].'</h6>
...
if(isset($_POST['name']) && isset($_POST['address']) && isset($_POST['contact']) ){
    ...
    //  
            ...
            $sql = "INSERT INTO `washpoint`( `point_address`,`point_name`,`contact`) VALUES ('$address','$name','$contact')";
...
if(isset($_POST['deleteid'])){
    ...
    $delete = "DELETE from `washpoint` where `id` = '$userid'";
...
if(isset($_POST['id']) && isset($_POST['id']) != "" ){ // chechinh weather id is null or not if not then run th next codes
                ...
                $sql = "SELECT * from `washpoint` where `id` = '$manageid'";
...
if(isset($_POST['add_hidden_id'])){
    ...
    $sql = "UPDATE `washpoint` SET `point_address`='$add_address', `point_name`='$add_name', `contact`='$add_contact' WHERE `id` = '$add_id'";
    $result = $connect->query($sql);
}

...
if(isset($_POST['readrecord'])){
                    ...
                    $display = "SELECT * from `managementteam`";
                        ...
                        $number = 1;
                          ...
                          while($row = mysqli_fetch_assoc($result)){
                            $data .= '<tr>
                                        ...
                                        <td>
                                            <div>
                                                <h6 class="text-primary">'.$row['post'].'</h6>
...
if(isset($_POST['name']) && isset($_POST['submit']) ){
    ...
    //  
            ...
            $sql = "INSERT INTO `managementteam`( `name`,`image` , `post`) VALUES ('$name','$image','$post')";
...
if(isset($_POST['deleteid'])){
    ...
    $delete = "DELETE from `managementteam` where `id` = '$userid'";
...
if(isset($_POST['id']) && isset($_POST['id']) != ""){ // chechinh weather id is null or not if not then run th next codes
                ...
                $sql = "SELECT * from `managementteam` where `id` = '$manageid'";
...
if(isset($_POST['add_hidden_id'])){
    ...
    $sql = "UPDATE `managementteam` SET `name`='$add_name',`post`='$add_post' WHERE `id` = '$add_id'";
    $result = $connect->query($sql);
}
